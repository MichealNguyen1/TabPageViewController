...
internal class TabView: UIView {
    ...
    init(isInfinity: Bool, option: TabPageOption) {
       super.init(frame: CGRect.zero)
        ...
        let top = NSLayoutConstraint(item: contentView != nil ? contentView! : UIView(),
            attribute: .top,
            relatedBy: .equal,
            toItem: self,
            attribute: .top,
        ...
        let left = NSLayoutConstraint(item: contentView != nil ? contentView! : UIView(),
            attribute: .leading,
            relatedBy: .equal,
            toItem: self,
            attribute: .leading,
        ...
        if !isInfinity, let currentBarView = currentBarView {
        ...
        bottomBarViewHeightConstraint.constant = 0.0
    }
